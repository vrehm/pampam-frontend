          ...
          <footer class="mt-8">
            <div class="flex">
              <div class="flex-shrink-0 inline-flex rounded-full border-2 border-white">
                <img class="h-12 w-12 rounded-full lazyload" data-src="~/assets/img/avatars/avatar-girl.jpeg" alt="" />
              </div>
              <div class="ml-4">
      ...
      <div class="py-12 px-4 border-t-2 border-indigo-900 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
        ...
        <blockquote class="mt-8 md:flex-grow md:flex md:flex-col">
          ...
          <footer class="mt-8">
            <div class="flex">
              <div class="flex-shrink-0 inline-flex rounded-full border-2 border-white">
                <img class="h-12 w-12 rounded-full lazyload" data-src="~/assets/img/avatars/avatar-boy.jpeg" alt="" />
              </div>
              <div class="ml-4">
                <div class="text-base leading-6 font-medium text-white">
                  Judith Black
